...
@HippoEssentialsGenerated(internalName = "amhippo:author")
@Node(jcrType = "amhippo:author")
public class Author extends HippoDocument implements AuthorEntry {

    public static final String ROLE = "amhippo:role";
    public static final String ACCOUNTS = "amhippo:accounts";
    public static final String FULL_NAME = "amhippo:fullname";
    public static final String IMAGE = "amhippo:image";
    public static final String CONTENT = "amhippo:content";

    @HippoEssentialsGenerated(internalName = "amhippo:fullname")
    ...
    @HippoEssentialsGenerated(internalName = "amhippo:role")
    public String getRole() {
        return getProperty(ROLE);
    }

    @HippoEssentialsGenerated(internalName = "amhippo:image")
    public HippoGalleryImage getImage() {
        return getLinkedBean(IMAGE, HippoGalleryImage.class);
    }

  	@HippoEssentialsGenerated(internalName = "amhippo:accounts")
