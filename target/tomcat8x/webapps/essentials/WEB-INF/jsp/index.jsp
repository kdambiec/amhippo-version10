...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/components/hippo-theme/dist/css/main.css?v=1.03.01"/>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/components/angular-ui-tree/dist/angular-ui-tree.min.css?v=1.03.01"/>
  <script type="application/javascript">
    window.SERVER_URL = '<%=request.getServerName()+':'+request.getServerPort()%>';
  </script>
  <script src="${pageContext.request.contextPath}/components/jquery/dist/jquery.js?v=1.03.01"></script>
  <script src="${pageContext.request.contextPath}/components/angular/angular.js?v=1.03.01"></script>
  <script src="${pageContext.request.contextPath}/components/chosen/chosen.jquery.js?v=1.03.01"></script>
  <script src="${pageContext.request.contextPath}/components/angular-chosen-localytics/chosen.js?v=1.03.01"></script>
  <script src="${pageContext.request.contextPath}/components/angular-bootstrap/ui-bootstrap-tpls.js?v=1.03.01"></script>
  <script src="${pageContext.request.contextPath}/components/angular-ui-router/release/angular-ui-router.js?v=1.03.01"></script>
  <script src="${pageContext.request.contextPath}/components/angular-sanitize/angular-sanitize.min.js?v=1.03.01"></script>

  <%-- HIPPO THEME DEPS --%>
  <script src="${pageContext.request.contextPath}/js/lib/angular-ui-tree.js?v=1.03.01"></script>
  <script src="${pageContext.request.contextPath}/components/google-code-prettify/src/prettify.js?v=1.03.01"></script>
  <script src="${pageContext.request.contextPath}/components/hippo-theme/dist/js/main.js?v=1.03.01"></script>

  <%-- ESSENTIALS --%>
  <script src="${pageContext.request.contextPath}/js/Essentials.js?v=1.03.01"></script>
  <script src="${pageContext.request.contextPath}/js/app.js?v=1.03.01"></script>
  <script src="${pageContext.request.contextPath}/js/routes.js?v=1.03.01"></script>
  <script src="${pageContext.request.contextPath}/js/directives.js?v=1.03.01"></script>
  <script src="${pageContext.request.contextPath}/js/controllers.js?v=1.03.01"></script>

  <link rel="icon" href="${pageContext.request.contextPath}/images/favicon.ico" type="image/x-icon"/>
  <link rel="shortcut icon" href="${pageContext.request.contextPath}/images/favicon.ico" type="image/x-icon"/>
</head>
<body id="container"  ng-cloak>
<div class="hidden" ng-include="'${pageContext.request.contextPath}/components/hippo-theme/dist/images/hippo-icon-sprite.svg?v=1.03.01'"></div>
